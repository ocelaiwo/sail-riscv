...
clean:
	...
	-rm -f c_emulator/riscv_exp.bc
	-rm -f elf.o riscv_model_RV32.o riscv_platform_impl.o riscv_platform.o riscv_prelude.o riscv_softfloat.o rts.o sail_failure.o sail.o
	ocamlbuild -clean
